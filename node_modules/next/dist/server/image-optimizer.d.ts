...
export declare function getSharp(concurrency: number | null | undefined): import("sharp").SharpConstructor;
export declare function isAvifDecodeSafe(heifVersion: string | null): boolean;
export declare function canDecodeAvif(concurrency: number | null | undefined): boolean;
